...
import {View, Text, StyleSheet, ScrollView,TouchabaleWithoutFeedback, TextInput, TouchableOpacity} from 'react-native'
...
class City extends React.Component {
    ...
    render() {
        ...
        return (
            <View style={{flex: 1}}>
                <ScrollView contentContainerStyle={[!city.location.length && {flex: 1}]}>
                    <View style ={[styles.locationsContainer, !city.locations.length && {flex: 1, justifyContent: 'center'}]}>
                        {
                            !city.locations.length && <CenterMessage message='No locations for this city!'></CenterMessage>
                        }
                        {
